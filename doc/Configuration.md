# Configuration Guide <br/> Retries Microservice

Retries microservice configuration structure follows the 
...
Example:
```yaml
- descriptor: "client-retries:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
...
Example:
```yaml
- descriptor: "client-retries:persistence:file:default:1.0"
  path: "./data/retries"
```
...
Example:
```yaml
- descriptor: "client-retries:controller:default:default:1.0"
...
Example:
```yaml
- descriptor: "client-retries:service:http:default:1.0"
  connection:
    protocol: "http"
    host: "0.0.0.0"
    port: 8080
