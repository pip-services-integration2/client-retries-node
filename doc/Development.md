# Development and Testing Guide <br/> Retries Microservice
...
- [How to Contribute](https://www.pipservices.org/community/contribute)
- [Styleguide](https://www.pipservices.org/community/codestyle)
- [ChangeLog](CHANGELOG.md)

> Please do **not** ask general questions in an issue. Issues are only to report bugs, request
  enhancements, or request new features. For general questions and discussions, use the
  [Contributors Forum](https://stackoverflow.com/questions/tagged/pipservice).
